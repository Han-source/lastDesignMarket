...
public class PartyController implements AuthenticationSuccessHandler, AccessDeniedHandler { // 8. PartyController class
																							// 생성
	...
	public void getList(Model model, @AuthenticationPrincipal Principal principal) { // 13.getList 함수 생성 , // 15. Model
																						// 이거 구글링해보고
		Party curUser = null;
		if (principal != null) {
