		...
		<div style="width: 60%; float: left;">
			...
			<form id='frmPost' action="/post/modifyPost" method="post">
				...
				<div style="height: 50px;">
					<label>작성자 : </label>
					<span><b><sec:authentication property="principal.curUser.userId"/></b></span>
				</div>
				...
				<div style="height: 300px; width:100%;  display: table-cell; vertical-align: middle;" class="form-group">
					<textarea id="txaContent" name="content" class="form-control" rows="10" style=" width:700%; margin:5px 0; padding:3px;" >${post.content}</textarea>
